...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  /**
   * How many assessment results are waiting for a human.
   *
   * Until a result is reviewed its band is NOT published, so a candidate who
   * earned an Expert badge shows nothing to employers. The page existed but
   * was not linked from anywhere, which meant a queue could sit unseen. The
   * count makes that impossible to miss.
   */
